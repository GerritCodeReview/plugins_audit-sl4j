...
public class AuditSshLog implements TransformableLog {
    ...
    public String toAuditLog(LoggerAudit loggerAudit) throws ParseException {
        //XXX 'elapse' is not correct since it is a final value calculated this way: TimeUtil.nowMs() - when;
        SshAuditEvent sshAuditEvent = new SshAuditEvent(this.session, getAuditUser(), this.command, getWhen(), null, null);
